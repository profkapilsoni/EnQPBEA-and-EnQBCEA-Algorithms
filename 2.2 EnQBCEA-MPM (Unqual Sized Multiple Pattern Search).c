/*
*************************************************************************************************************
*	About: The code implement Enhanced quantum based combined exact algorithm (EnQBCEA-MPM) for Unequal Size*
...
*	2.	EnQBCEA-MPM matching is performed for patterns set P = {P1, P2, P3} of equal lengths {3, 3, 3}		*
...
int main (int narg, char *varg[])
{
	...
	//An arbitrary pattern P1 = "TA" used for searching within the text "T"
	...
	//An arbitrary pattern P3 = "TGAC" used for searching within the text "T"
	...
	//STARTS - Quantum Approximate Filtering (QAF) Call for Simulated QCore 3
