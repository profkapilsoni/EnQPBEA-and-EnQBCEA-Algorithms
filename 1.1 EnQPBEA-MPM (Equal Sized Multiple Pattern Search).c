/*
*************************************************************************************************************
*	About: The code implements Enhanced QMEM processing based exact algorithm (EnQPBEA-MPM) for Equal Size	*
...
*	2.	EnQPBEA-MPM matching is performed for patterns set P = {P1, P2, P3} of equal lengths {3, 3, 3}		*
...
int main (int narg, char *varg[])
{
	...
	//The arbitrary patterns P1 = "T A A", P2 = "T A G", P3 = "T G A" are used for searching within the text sequence database "T"
	//START - Printing individual search pattern on each core that belongs to patterns set P = {P1, P2, P3} of equal lengths {3, 3, 3}
	...
	//END - Printing individual search pattern on each core that belongs to patterns set P = {P1, P2, P3} of equal lengths {3, 3, 3}
